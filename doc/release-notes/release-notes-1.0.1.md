## Shibacoin Core 1.0.1 Release Notes
...
***All users on Shibacoin 1.0.0 must upgrade to 1.0.1***

#### Technical Changes

* Set AuxPow activation height to `42,000`
* Change `CLIENT_NAME` from `satoshi` to `shibatoshi`
...
* Add `yelps` in place of `satoshi` in GUI tooltips
