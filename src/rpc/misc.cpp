...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total shibacoin balance of the wallet\n"
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given shibacoin address.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The shibacoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The shibacoin address validated\n"
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}")
        );
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}")
        );
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}")
            );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}")
        );
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"SWTFesnG9CKxM4FHNYbN1tmZhFYeWGbKhJ\"]}")
        );
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are shibacoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) shibacoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The shibacoin address to use for the signature.\n"
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw runtime_error(
            ...
            "shibacoin-cli and the GUI. There is no server-side difference."
        );
