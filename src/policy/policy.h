 ...
 *
 *  Shibacoin:    Increment mempool limits and accept RBF in steps of 0.0001 SHIC
...
/**
 * Shibacoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Shibacoin: Default hard dust limit that is evaluated when considering whether
