...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s shibacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  shibacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shibacoin transaction") + "\n" +
              "  shibacoin-tx [options] -create [commands]   " + _("Create hex-encoded shibacoin transaction") + "\n" +
              "\n";
