...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Shibacoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Shibacoin (as there is no actual maximum coins)
