...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Shibacoin Core repository on GitHub"),
        tr("Services that claim to double your shibacoins are always ponzi schemes")
    };
